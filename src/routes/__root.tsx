...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Paygod" },
      { name: "description", content: "Institutional Privacy Layer for LatAm Payments." },
      { property: "og:title", content: "Paygod" },
      { property: "og:description", content: "Institutional Privacy Layer for LatAm Payments." },
